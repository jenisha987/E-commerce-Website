...
export default function Header() {
    return (
        <div className="mt-24 text-white container bg-[url('./assets/images/17496.jpg')] min-h-[400px] lg:bg-cover bg-contain md:min-h-[650px] bg-no-repeat">
            <div className="absolute flex flex-col items-start gap-10 lg:w-1/4 w-1/3 md:py-32 lg:py-40 py-16">
                ...
                <button className='hover:bg-primary -mt-4 bg-white text-primary font-semibold hover:text-white
